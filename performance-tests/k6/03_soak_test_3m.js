 ...
 *
 * Jalankan: k6 run --env TARGET=backend performance-tests/k6/03_soak_test_3m.js
 */
...
export const options = {
  ...
  scenarios: {
    soak: {
      ...
      duration: '3m',    // Jangka pendek (3 menit) untuk pemanasan
    },
  },
  thresholds: {
...
export function handleSummary(data) {
  return {
    ...
    './results/soak_test_3m_summary.json': JSON.stringify(data, null, 2),
  };
}
